"""Alembic environment for the capital accounts bounded context.
...
from app.modules.capital_accounts.models import Base
...
def run_migrations_offline() -> None:
    ...
    context.configure(
        ...
        version_table="alembic_version_capital_accounts",
...
def run_migrations_online() -> None:
    ...
    if schema == DEFAULT_SCHEMA:
        raise RuntimeError(
            "Capital accounts migrations must target a per-fund schema. "
