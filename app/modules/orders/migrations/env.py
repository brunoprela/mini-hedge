"""Alembic environment for orders tables — per-fund schema isolation.

Same pattern as positions/compliance: tables live in fund-specific schemas
...
from app.modules.orders.models import Base
...
def run_migrations_offline() -> None:
    ...
    context.configure(
        ...
        version_table="alembic_version_orders",
...
def run_migrations_online() -> None:
    ...
    if schema == DEFAULT_SCHEMA:
        raise RuntimeError(
            "Orders migrations must target a per-fund schema. "
