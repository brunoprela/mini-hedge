...
class RegulatoryService:
    ...
    async def generate_form_pf(
        ...
        *,
        ...
        await self._repo.save_filing(record, session=session)
    ...
    async def generate_investor_statement(
        ...
        *,
        ...
        await self._repo.save_statement(record, session=session)
    ...
    async def generate_performance_letter(
        ...
        *,
        ...
        await self._repo.save_performance_letter(record, session=session)
    ...
    async def list_filings(
        ...
        *,
        ...
        records = await self._repo.list_filings(filing_type=filing_type, session=session)
        return [
            {
                "id": r.id,
