...
from app.modules.ai_analysis.core.prompts import build_prompt
...
if TYPE_CHECKING:
    ...
    from app.modules.ai_analysis.core.llm_adapter import LLMAdapter
    from app.modules.ai_analysis.repositories import (
