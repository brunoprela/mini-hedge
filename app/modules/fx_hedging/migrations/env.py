"""Alembic environment for the FX hedging bounded context.
...
from app.modules.fx_hedging.models import Base
...
def run_migrations_offline() -> None:
    ...
    context.configure(
        ...
        version_table="alembic_version_fx_hedging",
...
def run_migrations_online() -> None:
    ...
    if schema == DEFAULT_SCHEMA:
        raise RuntimeError(
            "FX hedging migrations must target a per-fund schema. "
