"""Alembic environment for the risk engine bounded context.
...
from app.modules.risk_engine.models import Base
...
def run_migrations_offline() -> None:
    ...
    context.configure(
        ...
        version_table="alembic_version_risk_engine",
...
def run_migrations_online() -> None:
    ...
    if schema == DEFAULT_SCHEMA:
        raise RuntimeError(
            "Risk engine migrations must target a per-fund schema. "
