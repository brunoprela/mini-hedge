"""Alembic environment for the investor operations bounded context.
...
from app.modules.investor_operations.models import Base
...
def run_migrations_offline() -> None:
    ...
    context.configure(
        ...
        version_table="alembic_version_investor_operations",
...
def run_migrations_online() -> None:
    ...
    if schema == DEFAULT_SCHEMA:
        raise RuntimeError(
            "Investor operations migrations must target a per-fund schema. "
