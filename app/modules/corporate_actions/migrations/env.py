"""Alembic environment for corporate actions tables — per-fund schema isolation.
...
def run_migrations_offline() -> None:
    ...
    context.configure(
        ...
        version_table="alembic_version_corporate_actions",
...
def run_migrations_online() -> None:
    ...
    if schema == DEFAULT_SCHEMA:
        raise RuntimeError(
            "Corporate actions migrations must target a per-fund schema. "
