"""Alembic environment for the fund structures bounded context.
...
from app.modules.fund_structures.models import Base
...
def run_migrations_offline() -> None:
    ...
    context.configure(
        ...
        version_table="alembic_version_fund_structures",
...
def run_migrations_online() -> None:
    ...
    if schema == DEFAULT_SCHEMA:
        raise RuntimeError(
            "Fund structures migrations must target a per-fund schema. "
