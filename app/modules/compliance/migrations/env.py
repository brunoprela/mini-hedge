"""Alembic environment for compliance tables — per-fund schema isolation.

Same pattern as positions: tables live in fund-specific schemas (fund_alpha,
fund_beta, etc.) via schema_translate_map.
"""
...
def run_migrations_online() -> None:
    ...
    if schema == DEFAULT_SCHEMA:
        raise RuntimeError(
            "Compliance migrations must target a per-fund schema. "
