"""Alembic environment for the attribution bounded context."""
...
from app.modules.attribution.models import Base
...
def run_migrations_offline() -> None:
    ...
    context.configure(
        ...
        version_table="alembic_version_attribution",
...
def run_migrations_online() -> None:
    ...
    if schema == DEFAULT_SCHEMA:
        raise RuntimeError(
            "Attribution migrations must target a per-fund schema. "
