"""Alembic environment for the quant research bounded context."""
...
from app.modules.quant_research.models import Base
...
def run_migrations_offline() -> None:
    context.configure(
        ...
        version_table="alembic_version_quant_research",
