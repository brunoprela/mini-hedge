...
from app.shared.auth.request_context import ActorType, RequestContext, get_request_context
...
FGA_PERMISSION_MAP: dict[str, str] = {
    ...
    "can_write_risk": Permission.RISK_WRITE,
    "can_read_fx_hedging": Permission.FX_HEDGING_READ,
    "can_write_fx_hedging": Permission.FX_HEDGING_WRITE,
