"""Unit tests for InvestorOperationsService — tests workflow orchestration with mocked repos."""
...
from app.modules.investor_operations.state_machine import InvalidTransitionError
...
def _make_service(
    *,
    ...
    return InvestorOperationsService(
...
class TestScreenInvestor:
    ...
    async def test_approved_screening(self) -> None:
        ...
        service = _make_service(kyc_adapter=kyc_adapter, kyc_repo=kyc_repo)
