...
class TestQuantResearchService:
    async def test_analyze_factor_raises_when_factor_not_found(
        self, service: QuantResearchService, factor_repo: AsyncMock
    ):
        factor_repo.get_by_name.return_value = None
    ...
    async def test_analyze_factor_returns_zeroed_result_when_no_returns(
        ...
        factor_repo.get_by_name.return_value = _make_factor_record(name="momentum")
        factor_repo.get_returns.return_value = []
        factor_repo.list_factors.return_value = []
        factor_repo.get_exposures.return_value = []
    ...
    async def test_compute_factor_exposures_raises_for_unknown_factor_type(
        ...
        factor_repo.get_by_name.return_value = _make_factor_record(
            factor_type="value"
        )  # no fn registered
        factor_repo.save_exposures.return_value = None
    ...
    async def test_compute_factor_exposures_saves_and_publishes(
        ...
        factor_repo.save_exposures.assert_called_once()
