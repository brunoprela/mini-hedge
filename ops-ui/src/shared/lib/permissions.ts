...
export const ROLE_PERMISSIONS: Record<string, string[]> = {
  ...
  analyst: ["can_read_instruments", "can_read_prices", "can_read_positions", "can_read_fund"],
  risk_manager: ["can_read_instruments", "can_read_prices", "can_read_positions", "can_read_fund"],
  compliance: ["can_read_instruments", "can_read_prices", "can_read_positions", "can_read_fund"],
  viewer: ["can_read_instruments", "can_read_prices", "can_read_positions", "can_read_fund"],
